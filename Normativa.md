...
1. Sobre l’objecte. 
  ...
  d’un treball de recerca i/o innovació a proposta d’un o diversos tutors o tutores de TFM, i sota la seva supervisió. Aquest treball ha
...
4. Sobre l’assignació de temes i de tutors.
  ...
  + La tutoria d’un TFM pot estar al càrrec d’una o varies persones, però com a mínim una d’elles ha de ser un professor o professora del Màster o de la Facultat de Matemàtiques i Informàtica. En casos excepcionals la CCM podrà autoritzar excepcions d'aquest article. 
...
6. Sobre l’avaluació.
  ...
  + En l’avaluació del TFM grupals es farà servir la [rúbrica](https://docs.google.com/spreadsheets/d/1g9foCpIxRSuA414hjeqWZNniJl_QC81W2x0P44_kngw/edit?usp=sharing) dissenyada, el [document d'avaluació entre parells](https://docs.google.com/document/d/1iYwW6xOXSaQ9ApzYHpk-GdLONF9VGV17rOod2ifFkQs/edit?usp=sharing) dissenyat i també el rànking entre alumnes que determini el tutor o director del projecte. 
  ...
  + Finalitzada l’avaluació de tots els treballs del semestre, la CCM revisa el treballs que a criteri dels tribunals i tutors mereixen ser considerats per una matrícula d'honor i atorgarà les que consideri convenients, sense excedir en casp cas el que preveu el RD1125/2003.
